...
doLog("Abriendo...");
    ...
    // Loading document.
doLog("accediendo a " + url);
    var loadingTask = PDFJS.getDocument(url);
doLog("getDocument DONE");
    this.pdfLoadingTask = loadingTask;

    loadingTask.onProgress = function (progressData) {
      doLog(" progreso..." + (progressData.loaded/progressData.total*100)+"% ")
...
var doLog = function ( txt  ) {
  cc.innerHTML+=txt;
}
var i =0;
document.getElementById("otro").addEventListener("click", function ( ) {
  var data = i%3;
  if ( data === 0 ) data = DEFAULT_URL;
  else if ( data === 1 ) data = '/otro.pdf'
  else data = "/mas.pdf"
